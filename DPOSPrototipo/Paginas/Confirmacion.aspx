<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Confirmacion.aspx.cs" Inherits="DPOSPrototipo.Paginas.Confirmacion" %>
            ...
            <tr>
                <td>
		            <table class="dGrid" cellspacing="1" cellpadding="0" border="0" id="gvDetalles" style="color:#333333;width:310px;">
			            <tr>
				            <td colspan="2" style="border:2px solid black;background:#CC0000; text-align:center;color:white;">CONFIRMADO</td>
			            </tr>
                        <tr>
